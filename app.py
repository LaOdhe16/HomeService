...
# =========================================
# 1. SETUP APLIKASI & DATABASE AZURE
# =========================================
app = Flask(__name__)

# Konfigurasi Database (Sesuai Azure)
DB_USER = "salvado"
...
# =========================================
# 4. DATABASE MODELS (Harus sama dengan .sql)
# =========================================
...
# User Loader untuk Login Manager
@login_manager.user_loader
def load_user(user_id):
    return User.query.get(int(user_id))

# =========================================
# 5. ROUTES (HALAMAN WEBSITE)
# =========================================
...
def book_service(service_id):
    # Logika sederhana pembuatan Invoice
...
def invoice(booking_id):
    ...
    # Pastikan yang buka invoice adalah pemilik atau adminnya
    ...
    try:
        ...
        param = {
            ...
            "item_details": [{
                ...
                "quantity": 1,
                "name": booking.service.title[:45] 
            }],
            "callbacks": {
                "finish": url_for('payment_success', booking_id=booking.id, _external=True)
            }
        }
...
# Route Bypass untuk demo/testing (jika Midtrans error)
...
if __name__ == '__main__':
    # Karena tabel sudah dibuat via SQL Terminal Azure, 
    # db.create_all() disini hanya untuk safety local development.
